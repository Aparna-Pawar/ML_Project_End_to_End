...
st.markdown("Fill in the claim details below to evaluate the probability of fraud.")
...
with st.form("main_form"):
    ...
    # --- SECTION 1: Policy & Customer Profile ---
...
# --- BACKEND INTEGRATION ---
if submit:
    # Constructing the payload with EXACT column names from your model
    payload = {
        "age": age,
        ...
        "collision_type": handle_unknown(collision_type),
        ...
        "property_damage": handle_unknown(property_damage),
        "bodily_injuries": bodily_injuries,
        "witnesses": witnesses,
        "police_report_available": handle_unknown(police_report),
    ...
    with st.spinner("Analyzing claim patterns..."):
        try:
            ...
            if response.status_code == 200:
                ...
                if result == "Fraudulent":
                    ...
                    st.warning("This claim shows high-risk patterns. Check incident severity and claim amount consistency.")
                else:
